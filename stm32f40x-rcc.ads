...
package STM32F40x.RCC is
   ...
   subtype PLLCFGR_PLLM_Element is STM32F40x.Bit;
   ...
   subtype PLLCFGR_PLLN_Element is STM32F40x.Bit;
   ...
   subtype PLLCFGR_PLLP_Element is STM32F40x.Bit;
   ...
   subtype PLLCFGR_PLLQ_Element is STM32F40x.Bit;
   ...
   subtype CFGR_SW_Element is STM32F40x.Bit;
   ...
   subtype CFGR_SWS_Element is STM32F40x.Bit;
